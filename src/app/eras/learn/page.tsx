...
export const metadata: Metadata = {
  title: "Learn Era — Study Abroad & University Pathways",
  description: "Student visa consultancy, university and course matching, and post-study work pathways across the UK, Australia, New Zealand and more.",
};

export default function LearnEraPage() {
  return (
    <div>
      <section className="bg-navy py-20 text-white">
        <div className="container-page">
          <p className="eyebrow mb-3 text-cyan">Learn Era</p>
          <h1 className="max-w-2xl text-4xl font-bold sm:text-5xl">Study Abroad, Universities &amp; Post-Study Work</h1>
      ...
      <section className="section">
        <div className="container-page">
          <SectionHeading eyebrow="Our Services" title="Everything you need for the Learn Era" />
      ...
      <section className="section bg-mist-2">
        <div className="container-page">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {whyChooseUs.map((w) => (
              <div key={w.title} className="flex items-start gap-3 rounded-2xl border border-line bg-white p-5">
          ...
          <p className="mt-10 max-w-2xl text-center mx-auto text-lg font-medium text-navy">
          ...
          <ol className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {processSteps.map((step, i) => (
              <li key={step.title} className="card p-6">
                <span className="font-mono text-2xl font-bold text-cyan">{String(i + 1).padStart(2, "0")}</span>
      ...
      <section className="section bg-mist-2">
        <div className="container-page">
          <SectionHeading eyebrow="Study Destinations" title="Explore where you could Learn" />
